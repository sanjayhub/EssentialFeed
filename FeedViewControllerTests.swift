...
class FeedViewControllerTests: XCTestCase {
    ...
    func test_loadingFeedIndicators_isVisibleWhileLoadingFeed() {
        let (sut, loader) = makeSUT()
        ...
        XCTAssertFalse(sut.isShowingLoadingIndicator, "Expected a loading request once loading completes successfully")
    ...
    func test_feedImageView_cancelsImageLoadingWhenNotVisibleAnymore() {
        ...
        XCTAssertEqual(loader.cancelledImageURLs, [image0.url], "Expected once called image URL request once first image is not visible anymore")
