...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_insert_overridesPreviouslyInsertedCacheValues() {
        ...
        XCTAssertNil(secondInsertionError, "Expected to be override cache successfully")
    ...
    func test_storeSideEffectsRunSerially() {
        ...
        XCTAssertEqual(completedOperationsInOrder, [op1, op2, op3], "Expected side-effects to be run serially but operations finished in wrong order")
    }
    ...
    private func expect(_ sut: FeedStore, toRetrieve expectedResult: RetrieveCachedResult, file: StaticString = #filePath, line: UInt = #line) {
        let exp = expectation(description: "wait for cache retrieval")
    ...
    private func expect(_ sut: FeedStore, toRetrieveTwice expectedResult: RetrieveCachedResult, file: StaticString = #filePath, line: UInt = #line) {
